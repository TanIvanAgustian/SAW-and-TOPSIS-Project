...
export default function ProgramsCards({ title, content, imageUrl, link}){
  return (
    <div className="max-w-xs rounded overflow-hidden shadow-lg h-full flex flex-col hover:animate-bigger-slowly">
  ...
  <div className="group px-6 mb-3 flex justify-center">
    ...
    <a
            className="inline-flex items-center justify-center px-4 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-xl hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900"
          >
            Learn More
            <svg
