    ...
    return (
        ...
        >
            ...
            <a href="#" className="-m-1.5 p-1.5">
                <img
                className="h-12 w-auto mx-auto block rounded-full"
                src={Logo}
                alt=""
                />
                <span className="ps-2 text-white">GDN</span>
                <span className="ps-2 text-white">Official Website</span>
            </a>
            </div>
            ...
            <Link to="/login" className="text-sm p-2 font-semibold leading-6 text-amber-50 rounded hover:bg-white hover:text-blue-900 my-3">
            ...
            <Link to="/" className="text-sm font-semibold leading-6 text-amber-50 px-2 rounded hover:bg-white">
                Home
            </Link>
            <Popover className="relative">
                <Popover.Button className="flex items-center gap-x-1 text-sm font-semibold leading-6 text-amber-50">
                Our Program
                <ChevronDownIcon
            ...
            <a href="#" className="text-sm font-semibold leading-6 text-amber-50 px-2 rounded hover:bg-white">
                News
            </a>
            <a href="#" className="text-sm font-semibold leading-6 text-amber-50 px-2 rounded hover:bg-white">
                Organization
            </a>
            <Link to="/about us" className="text-sm font-semibold leading-6 text-amber-50 px-2 rounded hover:bg-white">
                About Us
            </Link>
            </Popover.Group>
            </div>
        ...
        >
            ...
            <div className="mt-6 flow-root">
                ...
                <div className="space-y-2 py-6">
                    ...
                    {({ open }) => (
                        <>
                        <Disclosure.Button className="flex w-full items-center justify-between rounded-lg py-2 pl-3 pr-3.5 text-base font-semibold leading-7 text-amber-50 hover:bg-gray-50">
                            Product
                            <ChevronDownIcon
