          ...
          {loadingNews && loading ? (
            ...
            <div className="flex">
              <div className="w-9/12">
                ...
                <img
                  className="h-48 lg:h-auto max-h-[500px] my-3 rounded-2xl lg:w-full flex-none object-cover object-center mx-auto text-center overflow-hidden"
              ...
              <div className="w-3/12 mx-4">
                ...
                <ul class="max-w-md space-y-1 text-gray-500 font-medium  dark:text-gray-400">
                  {data?.events.slice(0, 3).map((program) => (
                    <Link to={"/programs/"+program.id}><li className="my-2 hover:animate-pulse">{program.title}</li></Link>
                  ))}
                </ul>
              </div>
            </div>
